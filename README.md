...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://PolianskyiDmytro.github.io/react_tabs-with-router/) and add it to the PR description.
